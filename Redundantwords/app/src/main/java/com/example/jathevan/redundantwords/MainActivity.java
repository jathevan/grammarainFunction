package com.example.jathevan.redundantwords;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void WOD(String s){
        ...
        if(s==null){
            ...
            String st= s;
            String[] words= {"advance notice" , "advance preview" , "at the present time", "close proximity","collaborate together","completely unanimous","end result","extra bonus","final outcome"
            ,"free gift","major breakthrough","new beginning","new innovation","past history","positive improvement","repeat again","erious crisis","totally unique"
            ,"unexpected surprise","unintended mistake"};
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
            alertDialogBuilder.setTitle("Results").setMessage("Number of redundant words   "+s1.size() ).setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                }
            }).setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
